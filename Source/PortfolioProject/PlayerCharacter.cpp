...
void APlayerCharacter::BeginPlay()
{
	...
	// Setet the interval between spells to default
...
void APlayerCharacter::ArcaneBlastSpell()
{
	...
	FVector ProjectileSpawnPointLocation = SpellSpawnPoint->GetComponentLocation();
...
void APlayerCharacter::ArcaneBombSpell()
{
	...
	// Set the interval between spells to prevent two spells being cast in tandem and colliding.
	CurrentSpellInterval = 0;
